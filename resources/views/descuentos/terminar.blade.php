      ...
      <div class="modal-body">
        ...
        <div class="container-fluid bd-example-row">
            ...
            <div class=" row row" >
                ...
                <div class="col-md-6">
                    {!!Form::file('pre_imagen2',['value'=>'Comprobante del Descuento', 'accept'=>'application/pdf'])!!}
                </div>
            </div>
...
<div id="gridSystemModal3{{$descuento->id}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="gridModalLabel" aria-hidden="true">
    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-content">
          ...
          <i class="fa fa-cog fa-spin fa-3x fa-fw"></i>
                ...
                <h4 align='left'><b>Agregar comprobante de inicio</b>  <span class="violet"></span></h4>
