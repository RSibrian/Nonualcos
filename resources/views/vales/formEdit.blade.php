    ...
    <div class="col-sm-6">
        ...
        <div class="input-group">
            ...
            <div class="form-group label-floating">
                ...
                @if ($esAdmin)
                    {!!Form::select('solicitante',$empleados,  $salida->idEmpleado ,['id'=>'solicitante','class'=>'form-control','required'])!!}
                @else
    ...
    <div class="col-sm-4">
        <div class="input-group">
            ...
            <div class="form-group label-floating">
                ...
                {!!Form::text('galones',\Helper::dinero($vale->galones),['id'=>'galones','class'=>'form-control','required'])!!}
            </div>
        </div>
    </div>
    ...
    <div class="col-sm-4">
        <div class="input-group">
            ...
            <div class="form-group label-floating">
                ...
                {!!Form::text('costoGalones',\Helper::dinero($vale->costoGalones),['id'=>'costoGalones','class'=>'form-control','required'])!!}
            </div>
        </div>
    </div>
