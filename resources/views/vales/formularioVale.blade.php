    ...
    <div class="col-sm-6">
        <div class="input-group">
            ...
            <div class="form-group label-floating">
                ...
                {!!Form::text('destino',old('destino'),['id'=>'destino','class'=>'form-control','required'])!!}
            </div>
        </div>
        <div class="input-group">
            <span class="input-group-addon">
    ...
    <div class="col-sm-12">
        <div class="input-group">
            ...
            <div class="form-group label-floating">
                ...
                {!!Form::textarea('mision',old('mision'),['id'=>'mision','class'=>'form-control','rows'=>'3','required'])!!}
            </div>
        </div>
    </div>
</fieldset>
        ...
        <div class="input-group">
         ...
         <div class="input-group">
            ...
            <div class="form-group label-floating">
                ...
                {!!Form::number('nGalones',old('nGalones'),['id'=>'nGalones','class'=>'form-control','min'=>'1','max'=>'50','required'])!!}
            </div>
        </div>
    ...
    <div class="col-sm-6">
        <div class="input-group">
            ...
            <div class="form-group label-floating">
                ...
                {!!Form::text('numeroVale',old('numeroVale'),['id'=>'numeroVale','class'=>'form-control', 'require', 'autocomplete' => 'off'])!!}
            </div>
        </div>
        <div class="input-group">
            <span class="input-group-addon">
        ...
        <div class="input-group">
            ...
            <div class="form-group label-floating">
                ...
                {!!Form::text('cVale',old('cVale'),['id'=>'cVale','class'=>'form-control', 'autocomplete' => 'off'])!!}
            </div>
    ...
    <div class="col-sm-6">
        <div class="input-group">
            ...
            <div class="form-group label-floating">
                ...
                {!!Form::text('empAutoriza',old('empAutoriza'),['id'=>'empAutoriza','class'=>'form-control datepicker'])!!}
    ...
    <div class="col-sm-6 col-sm-offset-4">
        <div class="input-group">
            <div class="form-group ">
                ...
                <label class="switch">
                    <input type="checkbox" name="estadoEntrega" id="estadoEntrega" checked>
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $("#numeroPlaca").mask("P000-000", options)
