                            ...
                            {{ csrf_field() }}
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-group  form-group{{ $errors->has('name') ? ' has-error' : '' }} label-floating">
                                                <label class="control-label">Usuario</label>
                                                 <input type="text" id="name" type="name" class="form-control" name="name" value="{{ old('name') }}" required autofocus>
                                ...
                                @endif
                                        ...
                                        <div class="footer text-center">
                                            <button type="submit" class="btn btn-info btn-simple btn-wd btn-lg">Iniciar</button>
                                        </div>
