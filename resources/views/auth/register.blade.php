    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="  ">
                    <a href="/SistemaALN/public/login">
                ...
                <li class="active">
                    <a href="{{ route('register') }}">
                        <i class="material-icons">person_add</i> Registarte
                    </a>
                </li>
            </ul>
        </div>
...
<div class="wrapper wrapper-full-page">
    <div class="full-page login-page" filter-color="black" data-image="/SistemaALN/public/img/login.jpg">
                            ...
                            <div class="card card-login card-hidden">
                                ...
                                <div class="card-content">
                                    <div class="input-group">
                                        ...
                                        <div class="form-group form-group{{ $errors->has('name') ? ' has-error' : '' }} label-floating">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="form-group form-group{{ $errors->has('password') ? ' has-error' : '' }} label-floating">
                                ...
                                <div class="footer text-center">
                                    <button type="submit" class="btn btn-info btn-simple btn-wd btn-lg">Registrar</button>
                                </div>
                            </div>
                            </div>>
                        </form>
