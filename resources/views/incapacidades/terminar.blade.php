<div id="gridSystemModal2{{$incapacidad->id}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="gridModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="container-fluid bd-example-row">
            ...
            {!!Form::model($incapacidad,['method'=>'PUT','enctype'=>'multipart/form-data','route'=>['incapacidades.update',$incapacidad->id]])!!}
            ...
            <div class=" row row" >
                ...
                <div class="col-md-6">
                    {!!Form::file('permisoPdf2',['value'=>'Comprobante de la incapacidad', 'accept'=>'application/pdf','required'])!!}
                </div>
            </div>
