...
(function( $, window, document, undefined ) {
	...
	var DataTable = function ( options )
	{
		 ...
		 *  @param {string|int} mAction Paging action to take: "Primera", "Anterior", "Siguiente" or "Ultimo"
	 ...
	 *  @param {object} settings DataTables settings object
	 *  @param {string|int} action Paging action to take: "Primera", "Anterior",
	 *    "Siguiente" or "Ultimo" or page number to jump to (integer)
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			...
			"oPaginate": {
				...
				/**
				 * Text to use for the 'Siguiente' pagination button (to take the user to the
				 * next page).
				 *  @type string
				 *  @default Next
				 *
		 ...
		 *
		 * * `simple` - 'Anterior' and 'Siguiente' buttons only
		 * * 'simple_numbers` - 'Anterior' and 'Siguiente' buttons, plus page numbers
		 * * `full` - 'Primera', 'Anterior', 'Siguiente' and 'Ultimo' buttons
		 * * `full_numbers` - 'Primera', 'Anterior', 'Siguiente' and 'Ultimo' buttons, plus
		 *   page numbers
		 *
	...
	DataTable.ext = _ext = {
		 ...
		 *      return [ 'Anterior', page, 'Siguiente' ];
		 *    };
		 */
		pager: {},
	...
	$.extend( extPagination, {
		...
		full: function ( page, pages ) {
			return [  'Primera', 'Anterior', 'Siguiente', 'Ultimo' ];
		},
		...
		full_numbers: function ( page, pages ) {
			return [ 'Primera', 'Anterior', _numbers(page, pages), 'Siguiente', 'Ultimo' ];
		},
